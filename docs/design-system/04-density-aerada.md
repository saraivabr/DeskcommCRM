...
escreve.ai tem como persona principal o **atendente que passa 8h/dia na ferramenta**. Decisões importantes:
...
|-----------|-----|-----|----------------------|
| Aerada | 56 | 24 | **escreve.ai (default)** — uso prolongado, atendimento, navegação tranquila |
...
❌ **Não é Notion exato.** Notion tem padding muito maior em containers (32px+) e linhas aerated principalmente em prose. escreve.ai aplica Aerada em componentes operacionais (inbox, kanban) e usa space-5/6 em containers.
...
escreve.ai v1.0 prioriza desktop/tablet. Phone é "view-only mode" (atendente não opera plenamente em phone).
