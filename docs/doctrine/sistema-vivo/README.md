...
| **Aplicação de referência** | Como o escreve.ai materializa o princípio. Cita tabela, arquivo, teste. | Fica de fora, ou entra como estudo de caso nomeado. | Você **reescreve** esta seção para o seu sistema. |
...
2. **Reescreva todas as seções "Aplicação de referência"** para os artefatos do seu sistema. Enquanto elas citarem o escreve.ai, a doutrina é decoração.
...
| **Implementação de referência** | escreve.ai |
