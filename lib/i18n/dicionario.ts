...
export const DICIONARIO: Traducoes = {
  ...
  "Uma ideia já é um começo. Descreva do seu jeito; a imagem e a legenda nascem daqui.": { es: "Una idea ya es un comienzo. Descríbela a tu manera; la imagen y el texto nacen aquí." },
  "Criando sua postagem…": { es: "Creando tu publicación…" },
  "Gerar imagem e legenda": { es: "Generar imagen y texto" },
  "Texto e imagem usam o saldo compartilhado de IA da empresa. O consumo varia conforme a criação.": { es: "El texto y la imagen usan el saldo compartido de IA de la empresa. El consumo varía según la creación." },
  "Consultar plano e uso": { es: "Consultar plan y uso" },
  "A imagem e a legenda ficam salvas para você revisar. Nada é publicado automaticamente.": { es: "La imagen y el texto quedan guardados para que los revises. Nada se publica automáticamente." },
  "Voltar para minhas criações": { es: "Volver a mis creaciones" },
  "Não foi possível detalhar o consumo de IA. Atualize a página para tentar novamente.": { es: "No se pudo desglosar el consumo de IA. Actualiza la página para intentarlo de nuevo." },
  "Sua primeira postagem com IA": { es: "Tu primera publicación con IA" },
  "Conte o que sua empresa faz e transforme uma ideia em imagem e legenda no Studio. Você revisa antes de compartilhar.": { es: "Cuéntanos qué hace tu empresa y transforma una idea en imagen y texto en el Studio. Puedes revisarlos antes de compartir." },
  "Abrir o Studio não consome IA. A geração começa quando você confirmar o pedido e usa o saldo disponível da empresa.": { es: "Abrir el Studio no consume IA. La generación comienza cuando confirmas la solicitud y usa el saldo disponible de la empresa." },
  "Não foi possível carregar a classificação. Recarregue a página.": { es: "No se pudo cargar la clasificación. Recarga la página." },
  "Classificação salva.": { es: "Clasificación guardada." },
  "Classificação comercial": { es: "Clasificación comercial" },
  "IA está em todos os planos. Contas existentes mantêm seu acesso; uma assinatura confirmada tem prioridade sobre esta classificação.": { es: "La IA está en todos los planes. Las cuentas existentes mantienen su acceso; una suscripción confirmada tiene prioridad sobre esta clasificación." },
  "Tipo de conta": { es: "Tipo de cuenta" },
  "Legado — ainda não classificado": { es: "Cuenta anterior — aún sin clasificar" },
  "Uso interno": { es: "Uso interno" },
  "Cortesia": { es: "Cortesía" },
  "Contrato externo": { es: "Contrato externo" },
  "Free beta": { es: "Free beta" },
  "Assinatura paga": { es: "Suscripción de pago" },
  "Beta fechado: configure os limites e o período antes de habilitar. A renovação é manual. Rascunhos e testes não ocupam vaga de funcionário publicado; o consumo de IA usa o mesmo saldo. Nos planos pagos, permanece a contagem atual de funcionários não arquivados.": { es: "Beta cerrada: configura los límites y el período antes de habilitarla. La renovación es manual. Los borradores y las pruebas no ocupan plazas de empleados publicados; el consumo de IA usa el mismo saldo. En los planes de pago se mantiene el recuento actual de empleados no archivados." },
  "Habilitar Free neste período": { es: "Habilitar Free en este período" },
  "Crédito e tarifa ficam registrados ao primeiro uso do período. Alterações posteriores valem para o próximo período; períodos utilizados não podem se sobrepor.": { es: "El crédito y la tarifa quedan registrados con el primer uso del período. Los cambios posteriores se aplican al próximo período; los períodos utilizados no pueden superponerse." },
  "Texto, imagens e voz usam este mesmo saldo. Durante uma operação, parte dele fica reservada. Ao concluir, descontamos o consumo e liberamos a diferença.": { es: "El texto, las imágenes y la voz usan este mismo saldo. Durante una operación, una parte queda reservada. Al finalizar, descontamos el consumo y liberamos la diferencia." },
  "Consumo de IA neste período": { es: "Consumo de IA en este período" },
  "Nenhuma operação registrada neste período.": { es: "No hay operaciones registradas en este período." },
  "Imagens": { es: "Imágenes" },
  "Outras operações": { es: "Otras operaciones" },
  "operações registradas": { es: "operaciones registradas" },
  "utilizados": { es: "utilizados" },
  "reservados": { es: "reservados" },
  "operações aguardando confirmação do consumo": { es: "operaciones pendientes de confirmación del consumo" },
  "Operações medem uso de IA; não equivalem a postagens, mensagens ou minutos entregues. Todas descontam do mesmo saldo, sem franquias separadas por recurso.": { es: "Las operaciones miden el uso de IA; no equivalen a publicaciones, mensajes ni minutos entregados. Todas se descuentan del mismo saldo, sin cupos separados por función." },
  "Seu Free beta": { es: "Tu Free beta" },
  "A definir": { es: "Por definir" },
  "Período de experimentação:": { es: "Período de prueba:" },
  "Os limites são desta conta de teste. Confira abaixo a validade e o saldo disponível antes de gerar. Sem cobrança automática de excedente.": { es: "Los límites corresponden a esta cuenta de prueba. Consulta abajo la vigencia y el saldo disponible antes de generar. Sin cobro automático por excedentes." },
  "IA em todos os planos": { es: "IA en todos los planes" },
  "Assistente, funcionários de IA e criação de conteúdo com imagens fazem parte de todos os planos. O que muda é o volume de uso, a equipe e os canais.": { es: "El asistente, los empleados de IA y la creación de contenido con imágenes forman parte de todos los planes. Lo que cambia es el volumen de uso, el equipo y los canales." },
  "Free beta: acesso por convite, com limites e período definidos para cada conta. A ativação é feita pela administração; seus acessos atuais não mudam automaticamente.": { es: "Free beta: acceso por invitación, con límites y período definidos para cada cuenta. La administración realiza la activación; tus accesos actuales no cambian automáticamente." },
  "funcionários de IA": { es: "empleados de IA" },
  "Mensalidade em reais. Texto, imagens e voz compartilham a franquia de IA da empresa. O consumo varia conforme o modelo e a operação; não há quantidade garantida de mensagens, imagens ou minutos. Sem cobrança automática de excedente.": { es: "Cuota mensual en reales. El texto, las imágenes y la voz comparten el saldo de IA de la empresa. El consumo varía según el modelo y la operación; no hay una cantidad garantizada de mensajes, imágenes ni minutos. Sin cobro automático por excedentes." },
  "Funcionários de IA publicados": { es: "Empleados de IA publicados" },
  "Seu acesso Free beta aguarda liberação da administração.": { es: "Tu acceso Free beta está pendiente de autorización de la administración." },
  "Seu Free beta está programado e aguarda o início do período.": { es: "Tu Free beta está programado y espera el inicio del período." },
  "Seu período Free beta expirou. Solicite a renovação manual à administração para voltar a gerar.": { es: "Tu período Free beta ha vencido. Solicita la renovación manual a la administración para volver a generar." },
  "Acesso gratuito de experimentação, com IA incluída.": { es: "Acceso gratuito de prueba, con IA incluida." },
  "Funcionários publicados": { es: "Empleados publicados" },
  "Crédito de IA (centavos de real)": { es: "Crédito de IA (centavos de real)" },
  "Tarifa comercial USD → BRL": { es: "Tarifa comercial USD → BRL" },
  "Início do período (UTC)": { es: "Inicio del período (UTC)" },
  "Fim do período (UTC)": { es: "Fin del período (UTC)" },
  "Salvar classificação": { es: "Guardar clasificación" },
  ...
  "Progresso da importação": { es: "Progreso de la importación" },
  "Importação": { es: "Importación" },
  "mensagens de texto importadas": { es: "mensajes de texto importados" },
  "Aguardando uma conexão WhatsApp compatível.": { es: "Esperando una conexión de WhatsApp compatible." },
  "Importando em segundo plano…": { es: "Importando en segundo plano…" },
  "Esta conexão foi pareada sem armazenamento de histórico. Uma nova conexão com sincronização habilitada é necessária.": { es: "Esta conexión se vinculó sin almacenamiento del historial. Se necesita una nueva conexión con la sincronización habilitada." },
  "A importação encontrou uma falha e será tentada novamente.": { es: "La importación encontró un error y se volverá a intentar." },
  ...
  "Playbook do atendimento": { es: "Guía de atención" },
  "Depois da importação, o sistema prepara um rascunho com base em conversas completas. Revise antes de orientar os agentes.": { es: "Después de importar, el sistema prepara un borrador basado en conversaciones completas. Revísalo antes de orientar a los agentes." },
  "Aguardando conversas suficientes para preparar o playbook automaticamente.": { es: "Esperando suficientes conversaciones para preparar la guía automáticamente." },
  "Aprovado e disponível para os agentes": { es: "Aprobado y disponible para los agentes" },
  "Rascunho para revisão": { es: "Borrador para revisión" },
  "Revise o texto antes de aplicar": { es: "Revisa el texto antes de aplicarlo" },
  "Ao aprovar, este conteúdo entra na Memória da IA e orienta todos os agentes da organização.": { es: "Al aprobarlo, este contenido entra en la Memoria de IA y orienta a todos los agentes de la organización." },
  "Aprovar e aplicar aos agentes": { es: "Aprobar y aplicar a los agentes" },
  "Conversas usadas como evidência": { es: "Conversaciones usadas como evidencia" },
  "extraído do histórico do WhatsApp": { es: "extraído del historial de WhatsApp" },
  "Ao conectar, as conversas anteriores são importadas e uma amostra com dados de contato removidos é analisada pelo provedor de IA configurado para preparar um playbook. Você revisa o rascunho antes de ele orientar os agentes.": { es: "Al conectar, se importan las conversaciones anteriores y el proveedor de IA configurado analiza una muestra sin datos de contacto para preparar una guía. Revisas el borrador antes de que oriente a los agentes." },
  ...
  "vezes": { es: "veces" },
  "Ainda não há perguntas repetidas suficientes para mostrar um padrão confiável.": { es: "Aún no hay suficientes preguntas repetidas para mostrar un patrón confiable." },
  "Padrões descritivos, não regras aprovadas. Para torná-los orientação geral dos agentes, registre a regra na": { es: "Patrones descriptivos, no reglas aprobadas. Para convertirlos en orientación general para los agentes, registra la regla en" },
  "Por contato": { es: "Por contacto" },
  "Buscar nome ou telefone": { es: "Buscar nombre o teléfono" },
  "Selecione um contato": { es: "Selecciona un contacto" },
  "Nenhuma mensagem histórica deste contato.": { es: "No hay mensajes históricos de este contacto." },
  "Exibindo as 100 mensagens mais recentes.": { es: "Mostrando los 100 mensajes más recientes." },
  "O histórico importado automaticamente, o panorama e a busca por contato estão em": { es: "El historial importado automáticamente, el panorama y la búsqueda por contacto están en" },
  ...
  "Estrutura da criação": { es: "Estructura de la creación" },
  "Imagem única": { es: "Imagen única" },
  "Uma imagem e uma legenda para revisar.": { es: "Una imagen y una descripción para revisar." },
  "Da notícia ao impacto no negócio": { es: "De la noticia al impacto en el negocio" },
  "Uma novidade de IA, seus usos reais e o que muda na operação da empresa.": { es: "Una novedad de IA, sus usos reales y lo que cambia en la operación de la empresa." },
  "8 slides para revisar antes de publicar.": { es: "8 diapositivas para revisar antes de publicar." },
  "Criando carrossel": { es: "Creando carrusel" },
  "Gerar carrossel de 8 slides": { es: "Generar carrusel de 8 diapositivas" },
  "Descreva a novidade, inclua a fonte, a data, o que ela faz, para quem está disponível e o impacto para o seu cliente.": { es: "Describe la novedad e incluye la fuente, la fecha, qué hace, para quién está disponible y el impacto para tu cliente." },
  "Este modelo gera oito imagens, uma operação de IA por slide. Mantenha esta página aberta até concluir.": { es: "Este modelo genera ocho imágenes, una operación de IA por diapositiva. Mantén esta página abierta hasta terminar." },
  "Cada slide é salvo na biblioteca ao terminar. A geração pode levar alguns minutos.": { es: "Cada diapositiva se guarda en la biblioteca al terminar. La generación puede tardar algunos minutos." },
  "Carregando slides…": { es: "Cargando diapositivas…" },
  "Revisar carrossel completo": { es: "Revisar el carrusel completo" },
  "slides prontos para revisão": { es: "diapositivas listas para revisar" },
  "Este carrossel ainda não está completo. Revise os slides na biblioteca antes de publicar.": { es: "Este carrusel todavía no está completo. Revisa las diapositivas en la biblioteca antes de publicar." },
  ...
  "Buscas automáticas": { es: "Búsquedas automáticas" },
  "Salve a configuração desligada. Ao ativar, o sistema repete as buscas e para no limite de execuções, no teto reservado, em falha ou quando não encontra novas empresas.": { es: "Guarde la configuración desactivada. Al activarla, el sistema repite las búsquedas y se detiene al alcanzar el límite de ejecuciones, el presupuesto reservado, un error o cuando no encuentra nuevas empresas." },
  "de teto reservado": { es: "de presupuesto reservado" },
  "Recorrência salva e desligada. Nenhuma busca foi iniciada.": { es: "Recurrencia guardada y desactivada. No se inició ninguna búsqueda." },
  "Fonte da recorrência": { es: "Fuente de la recurrencia" },
  "Público da recorrência": { es: "Público de la recurrencia" },
  "Região da recorrência": { es: "Región de la recurrencia" },
  "Intervalo entre buscas (horas)": { es: "Intervalo entre búsquedas (horas)" },
  "Empresas por busca": { es: "Empresas por búsqueda" },
  "Teto por busca (US$)": { es: "Límite por búsqueda (US$)" },
  "Máximo de buscas": { es: "Máximo de búsquedas" },
  "Teto total da recorrência (US$)": { es: "Límite total de la recurrencia (US$)" },
  "Abordagem após cada busca": { es: "Contacto después de cada búsqueda" },
  "Apenas coletar empresas": { es: "Solo recopilar empresas" },
  "Configuração salva": { es: "Configuración guardada" },
  "Para abordar automaticamente, reutilize uma campanha configurada com agente, canal, funil e critérios. O modo de teste e as proteções do canal continuam valendo. Uma busca já solicitada pode concluir mesmo após parar.": { es: "Para contactar automáticamente, reutilice una campaña configurada con agente, canal, embudo y criterios. El modo de prueba y las protecciones del canal siguen vigentes. Una búsqueda ya solicitada puede terminar después de detenerse." },
  "Salvar recorrência desligada": { es: "Guardar recurrencia desactivada" },
  "Recorrência ativada. O próximo ciclo pode consumir saldo.": { es: "Recurrencia activada. El próximo ciclo puede consumir saldo." },
  "Ativar buscas automáticas": { es: "Activar búsquedas automáticas" },
  "Recorrência parada e lote pausado.": { es: "Recurrencia detenida y lote pausado." },
  ...
  // ─── Extensões e Módulos Saraiva.AI / Escreve.ai ───
  ...
  "Entrada:": { es: "Entrada:" },
  "Saída:": { es: "Salida:" },
  "O provedor não retornou evidência completa. Não estime o custo pelos horários ou pelo texto da resposta.": { es: "El proveedor no devolvió la evidencia completa. No estime el costo por los horarios o por el texto de la respuesta." },
  ...
  "Some todas as etapas desta execução conforme a consulta ao provedor. Use zero somente se a ausência de custo foi comprovada.": { es: "Sume todas las etapas de esta ejecución según la consulta al proveedor. Use cero solo si se comprobó la ausencia de costo." },
  ...
  "Identifique o relatório ou consulta e as chamadas verificadas. Não inclua chaves, mensagens ou dados de clientes.": { es: "Identifique el informe o consulta y las llamadas verificadas. No incluya claves, mensajes ni datos de clientes." },
  ...
  "A equipe atingiu o limite do plano ou tem uma pendência na assinatura. Peça ao administrador para conferir Planos e assinatura e tente aceitar novamente.": { es: "El equipo alcanzó el límite del plan o tiene una suscripción pendiente. Pida al administrador que revise Planes y suscripción e intente aceptar nuevamente." },
  ...
  "O estado é atualizado após a confirmação do provedor. Voltar do pagamento não confirma a assinatura.": { es: "El estado se actualiza tras la confirmación del proveedor. Regresar del pago no confirma la suscripción." },
  ...
  "A integração precisa ser preparada pela equipe responsável. Depois, você autoriza sua conta na própria rede e escolhe onde receber as mensagens.": { es: "El equipo responsable debe preparar la integración. Después, autorizas tu cuenta en la red correspondiente y eliges dónde recibir los mensajes." },
  ...
  "A IA gerenciada já está disponível. Adicione uma chave própria somente se quiser usar outra conta; agentes existentes mantêm suas configurações.": { es: "La IA gestionada ya está disponible. Agrega una clave propia solo si deseas usar otra cuenta; los agentes existentes conservan sus configuraciones." },
  ...
  "Para consultar seu plano, faturas ou pagamentos, fale com a equipe responsável pelo seu acesso.": { es: "Para consultar tu plan, facturas o pagos, comunícate con el equipo responsable de tu acceso." },
  ...
  "Você já pode explorar. As configurações abaixo ainda precisam ser concluídas para começar o atendimento.": { es: "Ya puedes explorar. Las siguientes configuraciones aún deben completarse antes de iniciar la atención." },
  ...
  "Começamos com as instruções salvas do agente. Os ajustes abaixo valem para a voz; ferramentas e materiais do CRM não são usados neste teste.": { es: "Comenzamos con las instrucciones guardadas del agente. Los siguientes ajustes aplican a la voz; las herramientas y materiales del CRM no se usan en esta prueba." },
  "Duração máxima do teste": { es: "Duración máxima de la prueba" },
  "Converse com seu assistente": { es: "Conversa con tu asistente" },
  "Use seu microfone. O teste consome créditos da ElevenLabs. O áudio não é gravado; a transcrição fica no provedor por até 7 dias.": { es: "Usa tu micrófono. La prueba consume créditos de ElevenLabs. El audio no se graba; la transcripción permanece en el proveedor hasta 7 días." },
  ...
  "Converse com o conteúdo do seu CRM. Encontre informações, entenda suas conversas e acompanhe o funil.": { es: "Conversa con el contenido de tu CRM. Encuentra información, comprende tus conversaciones y sigue el embudo." },
  ...
  "Não foi possível confirmar o salvamento. Suas alterações continuam nesta tela. Tente novamente.": { es: "No fue posible confirmar el guardado. Tus cambios siguen en esta pantalla. Inténtalo de nuevo." },
  ...
  "Conte como você quer atender. A conversa organiza uma proposta que você pode revisar e ajustar.": { es: "Cuenta cómo deseas atender. La conversación organiza una propuesta que puedes revisar y ajustar." },
  "Conversa de criação": { es: "Conversación de creación" },
  "Pode começar pelo seu negócio, por uma tarefa ou pelo que hoje toma seu tempo. Eu pergunto só o que faltar.": { es: "Puedes comenzar por tu negocio, por una tarea o por lo que hoy te toma tiempo. Preguntaré solo lo que falte." },
  ...
  "Esta conversa prepara uma proposta. O agente só é salvo no editor e só atende depois de você publicar.": { es: "Esta conversación prepara una propuesta. El agente solo se guarda en el editor y solo atiende después de publicar." },
  ...
  "O funcionário deixa de responder e sai da equipe ativa. Treinamentos publicados e histórico são preservados para auditoria. Não é possível desarquivar pela interface nesta versão.": { es: "El empleado deja de responder y sale del equipo activo. Las instrucciones publicadas y el historial se conservan para auditoría. No es posible desarchivar desde la interfaz en esta versión." },
  ...
  "Cada funcionário começa com missão, limites e linguagem da função. Você revisa o treinamento, escolhe o número e publica quando estiver pronto.": { es: "Cada empleado comienza con misión, límites y tono de la función. Revisas el entrenamiento, eliges el número y publicas cuando esté listo." },
  ...
  'Crie seu primeiro gatilho para responder comentários como "EU QUERO" ou "PREÇO" enviando uma DM instantânea com seu link.': { es: "Crea tu primer disparador para responder comentarios como 'QUIERO' o 'PRECIO' enviando un mensaje directo instantáneo con tu enlace." },
  ...
  "A IA chama a pessoa pelo nome e retoma o assunto deste atendimento, sem pedir que ela explique tudo de novo.": { es: "La IA llama a la persona por su nombre y retoma el tema de esta atención, sin pedir que explique todo de nuevo." },
  ...
  "Seu WhatsApp de mensagens não conecta as chamadas automaticamente. Conecte o número uma vez pelo QR Code.": { es: "Tu WhatsApp de mensajería no conecta las llamadas automáticamente. Conecta el número una vez mediante el código QR." },
  ...
  "Crie a persona, escolha o número que será auditado, dispare o teste e acompanhe cada execução.": { es: "Crea el perfil, elige el número que se auditará, inicia la prueba y sigue cada ejecución." },
  ...
  "Defina quem o cliente simulado será, qual número receberá a abordagem e o que deve ser avaliado.": { es: "Define quién será el cliente simulado, qué número recibirá el contacto y qué debe evaluarse." },
